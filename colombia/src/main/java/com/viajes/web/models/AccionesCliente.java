...
public static int registrarCliente(Cliente cliente){
    ...
    try {
        ...
        String queryRegistrar = "INSERT INTO clientes(nombre,apellido,contacto,comentarios) VALUES (?,?,?,?)";
        ...
        String comentariosCliente = cliente.getComentarios();
        ...
        pst.setString(4, comentariosCliente);
...
public static int actualizarCliente(Cliente cliente){
    ...
    try {
        ...
        String queryActualizar = "UPDATE clientes SET nombre=?,apellido=?,contacto=?,comentarios=? WHERE id=?";
...
public static Cliente verCliente(int idAConsultar){
    ...
    try {
        ...
        if (consultaCliente.next()){
            ...
            clienteADevolver.setComentarios( consultaCliente.getString(5));
            connection.close();
        }
    } catch (Exception e){
        System.out.println(e);
